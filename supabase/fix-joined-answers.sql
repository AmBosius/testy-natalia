-- Автоматически сгенерировано: чиним "склеенные в один массив" ответы
-- для word-заданий с несколькими пропусками (были отдельными альтернативами,
-- должны быть одной строкой через запятую).
...
-- Структурно странные (вручную непонятно, как объединять) - снять с публикации
update questions set published = false where id = 4820;